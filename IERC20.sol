...
import "./custom-lib/SafeMath.sol";
...
contract ERC20Basic is IERC20 {
    ...
    function allowance(address owner, address delegate) public override view returns (uint256) {
        return allowedMapping[owner][delegate];
    }
    ...
    function approve(address delegate, uint256 tokensNumber) public override returns (bool) {
        allowedMapping[msg.sender][delegate] = tokensNumber;
        emit Approval(msg.sender, delegate, tokensNumber);
        return true;
    }
